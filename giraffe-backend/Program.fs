...
let configureCors (builder: CorsPolicyBuilder) =
    builder
        .WithOrigins("https://gdple.iainschmitt.com", "http://localhost:5173")
        .AllowAnyMethod()
        .AllowAnyHeader()
    |> ignore
...
let giraffeMain args =
    ...
    let trigger =
        TriggerBuilder
            ...
            .WithSchedule(CronScheduleBuilder.DailyAtHourAndMinute(10, 47).InTimeZone(TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time")))
