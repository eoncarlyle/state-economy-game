...
export default function AboutPage() {
    ...
    const guess: Guess = {stateRecord: StateRecord.of("Alabama"), bearing: 45, gdpRatio: 1.5, isWin: false}
    return (
        <>
            ...
            <div className="landing-copy">
                ...
                <p>
                    As an example, if you guessed "Alabama" then saw the following row, that
                    would mean that correct state is northeast of Alabama, and has an
                    economy roughly one and a half times larger.
                </p>
                <div className="guesses">
                    <GuessRow guess={guess} isDisplay={true}/>
                </div>
                <p> Email{" "} <a href="mailto:gdple@iainschmitt.com">here</a> to report any issues!
